...
*Eight seconds of `make demo`, recorded by `make gif` — **v0.5.1**, 19 Aug
...
*The chase camera, from `make demo` at `--sky 3` — **v0.5.1**, 19 Aug 2026.
The cab's
...
*The copter, from `--copter --haze 1 --sky 5` — **v0.5.1**, 19 Aug 2026. How
far
...
*`--sky 8 --day 0` — **v0.5.1**, 19 Aug 2026. The green sunset, held still
for the picture.*
...
**v0.5.1**, 19 Aug 2026. The mode the name is about, and the one that runs
...
```sh
$ ascitty --version
ascitty 0.5.1 (seed 0xa5c1771e)
```

Releases are tagged `v0.5.1` and so on, and every picture in this README
...
40×25 city on a 1.76 MHz 7501. **v0.5.1**, 19 Aug 2026.*
